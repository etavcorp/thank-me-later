<template>
  <section class="pt-32 pb-24 max-w-7xl mx-auto px-4 min-h-screen flex items-center">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-16 items-center" v-fade-scroll>
      <div>
        <img src="https://images.unsplash.com/photo-1583394838336-acd977736f90?ixlib=rb-4.0.3&auto=format&fit=crop&w=800&q=80" alt="Chef Vince Mogul" class="rounded-sm grayscale hover:grayscale-0 transition-all duration-700 object-cover h-[600px] w-full">
      </div>
      <div>
